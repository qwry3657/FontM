...
public class en extends AppCompatActivity {
    ...
    private static final String SA1_KEY = "SaOverlaysFONTS16.overlay";
    private static final String SA2_KEY = "SaOverlaysFONTS17.overlay";
    private static final String SA3_KEY = "SaOverlaysFONTS18.overlay";
    private static final String SA4_KEY = "SaOverlaysFONTS19.overlay";
    private static final String SA5_KEY = "SaOverlaysFONTS20.overlay";

    LinearLayout[] Container;
    LinearLayout AuroraContainer, GradiconContainer, LornContainer, PlumpyContainer, AcherusContainer, CircularContainer, FilledContainer, KaiContainer, OosContainer, OutlineContainer, PuiContainer, RoundedContainer, SamContainer, VictorContainer, AclonicaContainer, Sa1Container, Sa2Container, Sa3Container, Sa4Container, Sa5Container;
    Button Aurora_Enable, Aurora_Disable, Gradicon_Enable, Gradicon_Disable, Lorn_Enable, Lorn_Disable, Plumpy_Enable, Plumpy_Disable, Acherus_Enable, Acherus_Disable, Circular_Enable, Circular_Disable, Filled_Enable, Filled_Disable, Kai_Enable, Kai_Disable, Oos_Enable, Oos_Disable, Outline_Enable, Outline_Disable, Pui_Enable, Pui_Disable, Rounded_Enable, Rounded_Disable, Sam_Enable, Sam_Disable, Victor_Enable, Victor_Disable, Aclonica_Enable, Aclonica_Disable, Sa1_Enable, Sa1_Disable, Sa2_Enable, Sa2_Disable, Sa3_Enable, Sa3_Disable, Sa4_Enable, Sa4_Disable, Sa5_Enable, Sa5_Disable;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addItem(R.id.sa1_container, "Arial Rounded", "Tap to enable/desable font.", R.id.sa1_enable, R.id.sa1_disable);
        addItem(R.id.sa2_container, "Arial Rounded", "Tap to enable/desable font.", R.id.sa2_enable, R.id.sa2_disable);
        addItem(R.id.sa3_container, "Arial Rounded", "Tap to enable/desable font.", R.id.sa3_enable, R.id.sa3_disable);
        addItem(R.id.sa3_container, "Arial Rounded", "Tap to enable/desable font.", R.id.sa4_enable, R.id.sa4_disable);
        addItem(R.id.sa5_container, "Arial Rounded", "Tap to enable/desable font.", R.id.sa5_enable, R.id.sa5_disable);
        ...
        // List of Icon Pack
        Container = new LinearLayout[]{AuroraContainer, GradiconContainer, LornContainer, PlumpyContainer, AcherusContainer, CircularContainer, FilledContainer, KaiContainer, OosContainer, OutlineContainer, PuiContainer, RoundedContainer, SamContainer, VictorContainer, Sa1Container, Sa2Container, Sa3Container, Sa4Container, Sa5Container};
        ...
        enableOnClickListener(Sa1Container, Sa1_Enable, Sa1_Disable, SA1_KEY, 16);
        enableOnClickListener(Sa2Container, Sa2_Enable, Sa2_Disable, SA2_KEY, 17);
        enableOnClickListener(Sa3Container, Sa3_Enable, Sa3_Disable, SA3_KEY, 18);
        enableOnClickListener(Sa4Container, Sa4_Enable, Sa4_Disable, SA4_KEY, 19);
        enableOnClickListener(Sa5Container, Sa5_Enable, Sa5_Disable, SA5_KEY, 20);
    ...
    private void refreshLayout(LinearLayout layout) {
        for (LinearLayout linearLayout : Container) {
            if (!(linearLayout == layout)) {
                ...
                } else if (linearLayout == Sa1Container) {
    ...
    private void refreshBackground() {
        ...
        checkIfApplied(Sa1Container, 16);
        checkIfApplied(Sa2Container, 17);
        checkIfApplied(Sa3Container, 18);
        checkIfApplied(Sa4Container, 19);
        checkIfApplied(Sa5Container, 20);
