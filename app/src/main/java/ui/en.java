...
public class en extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        enableOnClickListener(Sas1Container, Sas1_Enable, Sas1_Disable, SAS1, 21);
        enableOnClickListener(Sas2Container, Sas2_Enable, Sas2_Disable, SAS2, 22);
    ...
    private void refreshLayout(LinearLayout layout) {
        for (LinearLayout linearLayout : Container) {
            if (!(linearLayout == layout)) {
                ...
                } else if (linearLayout == Sas1Container) {
    ...
    private void refreshBackground() {
        ...
        checkIfApplied(Sas1Container, 21);
        checkIfApplied(Sas2Container, 22);
