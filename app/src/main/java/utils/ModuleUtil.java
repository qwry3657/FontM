...
public class ModuleUtil {
    ...
    public static final String MODULE_DIR = "/data/adb/modules/Font_Manager";
    public static final String OVERLAY_DIR = "/data/adb/modules/Font_Manager/system/product/overlay";
    ...
    static void installModule(Context context) {
        ...
        Shell.cmd("printf 'id=Font_Manager\n" +
                "name=Font_Manager\nversion=" + BuildConfig.VERSION_NAME + "\n" +
                "versionCode=" + BuildConfig.VERSION_CODE + "\n" +"" +
                "author=Sã Śâjjãd\n" +
                "description=Systemless module for Font_Manager.\n' > " + MODULE_DIR + "/module.prop").exec();
